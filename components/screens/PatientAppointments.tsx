...
export default function PatientAppointments() {
  ...
  useEffect(() => {
    const now = new Date();
    const [up, past] = mockBookings.reduce<[Booking[], Booking[]]>(([up, past], booking) => {
  ...
  const BookingCard = ({ booking }: { booking: Booking }) => (
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
      <div className="flex justify-between items-center mb-1">
        <h3 className="text-base font-medium text-gray-900">{booking.doctorName}</h3>
  ...
  return (
    <div className="min-h-screen px-6 pt-6 pb-24 bg-gray-50 space-y-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
